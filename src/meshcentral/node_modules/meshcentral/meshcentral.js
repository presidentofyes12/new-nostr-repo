...
//const { verifyToken, getSession } = require('/home/impromise/Downloads/Telegram\ Desktop/new/nostr-w-relay-main/src/server/auth/nostrAuth.js');
const express = require('express');
const app = express();
//const { verifySSOCredentials } = require('/home/impromise/Downloads/Telegram\ Desktop/new/nostr-w-relay-main/src/server/ssoAuth.js');
...
function CreateMeshCentralServer(config, args) {
	...
	/*app.use((req, res, next) => {
	  const username = req.cookies['ssoUsername'];
	  const password = req.cookies['ssoPassword'];

	  if (verifySSOCredentials(username, password)) {
	    req.user = { publicKey: username };
	    next();
	  } else {
