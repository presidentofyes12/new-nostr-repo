        ...
        <div id="column_l" style="overflow-y:auto">
            ...
            <div>
                ...
                <div id="macostab" class="tabcontent" style="background-color:white;color:black">
                    <h3>Apple™ MacOS</h3>
                    <p><a id="macosurl">Den Installer hier herunterladen</a>, rechtsklicken oder "Ctrl" halten und Datei anklicken. Anschließend "Öffnen" wählen und den Anweisungen folgen.</p>
                    <div style="text-align:center">
